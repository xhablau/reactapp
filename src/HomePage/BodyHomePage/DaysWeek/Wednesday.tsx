...
interface PropsWednesday {
    propsWednesday: Array<{
...
const Wednesday: React.FC<PropsWednesday> = ({ propsWednesday }) => {
    const customStyles = {
        content: {
            top: '50%',
            left: '50%',
